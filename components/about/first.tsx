...
const First = () => {
  return (
    <div className='mx-auto max-w-screen-xl px-8 pt-8'>
       <h1 className=" text-[38px] lg:text-[50px] xl:text-[70px]  font-sans font-light">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2">
        ...
        <div className='pb-5 md:pr-8'>
          ...
          <div className=' pb-5'>
            <h1 className=" text-[40px] lg:text-[50px] xl:text-[70px]  font-sans font-light md:pl-8">
            Our Purpose
          </h1>
          <p className="text-[17px] md:pl-8 ">
