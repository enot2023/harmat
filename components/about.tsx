    ...
    <div className='mb-4'>
      ...
      <div className='grid grid-rows-2 md:grid-rows-1 md:grid-cols-2 '>
        <div className='flex items-center justify-center gap-10 lg:gap-24 -mt-10 lg:mt-8'>
          <p  className='order-2 lg:order-1 text-center md:px-4'>Contact us at : <a href="mailto:contact@harmatenterprise.com">contact@harmatenterprise.com</a></p>
        ...
        <div className='flex items-center  justify-center mx-5 lg:mx-24 md:ml-24 font-serif font-semibold'>
