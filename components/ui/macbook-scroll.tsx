...
export const MacbookScroll = ({
  ...
  const translate = useTransform(scrollYProgress, [0, 1], [0, 3000]);
  ...
  return (
    <div
      ref={ref}
      className="md:min-h-[200vh]  flex flex-col items-center py-0 md:py-72 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.65] sm:scale-50"
    >
      <motion.h2
        style={{
